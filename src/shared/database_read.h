...
inline void open_db_connection(const std::string& full_db_path, sqlite3*& db) {
...
inline bool read_header(sqlite3* db, const std::string& header_name, std::string& header_value) {
